...
#define STRING_CONFIG_H_AUTHOR "(Axel Barkow, Wallpaintbot)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Wall Paint Bot"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 90*60, 90*60, 90*60 }
